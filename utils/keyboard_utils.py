...
class Buttons:
    ...
    def get_setmodel_inline_kb() -> InlineKeyboardButton:
        ...
        [InlineKeyboardButton(text="Ministral-8B", callback_data="mistralai/Ministral-8B-Instruct-2410")],
        ...
        [InlineKeyboardButton(text="dbrx", callback_data="databricks/dbrx-instruct")],
